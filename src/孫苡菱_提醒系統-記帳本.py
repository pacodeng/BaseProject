...
while(1):
    ...
    if(selection == 1):  # 顯示紀錄
        ...
        if(selection == 1):
            ...
            print("The sum of expense: -%d dollars" % (total_amount))  # 輸出總支出
            just = input("Input Anything To Continue...")
        elif(selection == 2):
            ...
            print("The sum of earnings: +%d dollars" % (total_amount))  # 輸出總收入
            just = input("Input Anything To Continue...")
        elif(selection == 3):
        ...
        just = input("Input Anything To Exit...")
        break
